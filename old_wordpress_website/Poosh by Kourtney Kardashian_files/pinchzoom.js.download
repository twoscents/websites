                    ...
                    if (interaction !== newInteraction) {
                        ...
                        if (interaction && !newInteraction) {
                            switch (interaction) {
                                case "zoom":
                                    ...
                                    $('.product-col-1 #thumbnails').find('.tapzoom').text('Double Tap to Zoom');
                                    $('.product-col-1.product-image-container').find('.cursor-text.show-mobile p').text('Double Tap to Zoom');
                                    break;
                                case 'drag':
                        ...
                        switch (newInteraction) {
                            case 'zoom':
                                ...
                                $('.product-col-1.product-image-container').find('.cursor-text.show-mobile p').text('Drag to Move');
                                $('.product-col-1 #thumbnails').find('.tapzoom').text('Drag to Move');
                                break;
                            case 'drag':
